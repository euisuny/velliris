...
define void @print_buffer(ptr nocapture noundef readonly %0, i64 noundef %1) local_unnamed_addr #0 {
  br label %3
...
3:                                                ; preds = %3, %2
  ...
  call void @print_string(ptr noundef %6) #2
  %7 = add i64 %4, 1
  %8 = icmp eq i64 %7, %1
...
declare void @print_string(ptr noundef) local_unnamed_addr #1

attributes #0 = { nounwind ssp uwtable(sync) "disable-tail-calls"="true" "frame-pointer"="non-leaf" "min-legal-vector-width"="0" "no-trapping-math"="true" "probe-stack"="__chkstk_darwin" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
