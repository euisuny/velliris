...
Proof.
  ...
  - revert x y H H0.
    ...
    + punfold H0. red in H0.
      ...
      * rewrite <- Heqox. destruct e.
        -- inversion H1.
        -- econstructor. intros.
           specialize (REL x0). red in REL. pclearbot. right. eapply CIH.
           +++ apply REL.
           +++ apply inj_pair2 in H3. rewrite <- H3. specialize (H0 x0). apply H0.
...
Proof.
  ...
  - destruct obs; cbn in *; inversion Heqi0.
    eapply IHeqitF; [ apply Heqobt | ..].
    2 : { apply Heqi. }
    + assert (observe t0 = observe t0) by reflexivity. apply H.
